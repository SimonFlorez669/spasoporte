...
public class EquipoTrabajoEntity {
	...
	public EquipoTrabajoEntity(final UUID id,final String nombreEmpleado,final String cargo,final String titulos, final String descripcion,
			final File foto) {
	...
	public static final  EquipoTrabajoEntity crear(final UUID id, final String NombreEmpleado, final String Cargo,final String titulos, final String descripcion, final File foto) {
		return new EquipoTrabajoEntity(id, NombreEmpleado, Cargo,descripcion,titulos,foto);
	}
