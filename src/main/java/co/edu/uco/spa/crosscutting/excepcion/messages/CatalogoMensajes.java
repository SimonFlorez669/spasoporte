...
private static final Map<CodigoMensaje, Mensaje> MENSAJES = new HashMap<>();
	...
	private static final void cargarMensajes() {
		...
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000073, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"La longitud del codigo del tipo de identificacion no es valida. la longitud Maxima son 50 caracteres"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000074, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"\"El campo 'nombre' es obligatorio y no puede ser nulo o vacío\""));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000075, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"El campo 'nombre' no puede tener más de 255 caracteres"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000076, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"El campo 'codigo' no puede tener más de 10 caracteres"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000077, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"ya existe un tipo de identificacion con el nombre"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000078, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"ya existe un tipo de identificacion con el mismo codigo"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000079, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toDomain de la Clase AcercaNosotros. No es Posible mapear un AcercaNosotros dominio a partir de una entidad de tipo AcercaNosotros entity nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000080, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toDomain de la Clase AtencionCliente. No es Posible mapear un  AtencionCliente dominio a partir de una entidad de tipo AtencionCliente entity nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000081, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toEntity de la Clase AcercaNosotros. No es Posible mapear un AcercaNosotros entity a partir de una entidad AcercaNosotros domain nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000082, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toEntity de la Clase AtencionCliente. No es Posible mapear un AtencionCliente entity a partir de una entidad de AtencionCliente domain nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000083, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toEntity de la Clase EquipoTrabajo. No es Posible mapear un EquipoTrabajo entity a partir de una entidad de EquipoTrabajo domain nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000084, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toDomain de la Clase EquipoTrabajo. No es Posible mapear un EquipoTrabajo dominio a partir de una entidad de tipo EquipoTrabajo entity nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000085, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toDomain de la Clase Inventario. No es Posible mapear un Inventario dominio a partir de una entidad de tipo Inventario entity nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000086, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toEntity de la Clase Inventario. No es Posible mapear un Inventario entity a partir de una entidad de Inventario domain nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000087, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toDomain de la Clase Notificacion. No es Posible mapear una Notificacion dominio a partir de una entidad de tipo Notificacion entity nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000088, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toEntity de la Clase Notificacion. No es Posible mapear un Notificacion entity a partir de una entidad de Notificacion domain nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000089, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toDomain de la Clase Pago. No es Posible mapear un Pago dominio a partir de una entidad de tipo Pago entity nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000090, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toEntity de la Clase Pago. No es Posible mapear un Pago entity a partir de una entidad de Pago domain nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000091, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toDomain de la Clase Precios. No es Posible mapear Precios dominio a partir de una entidad de tipo Precios entity nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000092, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toEntity de la Clase Precios. No es Posible mapear Precios entity a partir de una entidad de Precios domain nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000093, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toDomain de la Clase Producto. No es Posible mapear Producto dominio a partir de una entidad de tipo Producto entity nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000094, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toEntity de la Clase Producto. No es Posible mapear Producto entity a partir de una entidad de Producto domain nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000095, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toDomain de la Clase RestriccionServicio. No es Posible mapear RestriccionServicio dominio a partir de una entidad de tipo RestriccionServicio entity nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000096, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toEntity de la Clase RestriccionServicio. No es Posible mapear RestriccionServicio entity a partir de una entidad de RestriccionServicio domain nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000097, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toDomain de la Clase Servicio. No es Posible mapear Servicio dominio a partir de una entidad de tipo Servicio entity nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000098, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toEntity de la Clase Servicio. No es Posible mapear Servicio entity a partir de una entidad de Servicio domain nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000099, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toDomain de la Clase Sucursal. No es Posible mapear Sucursal dominio a partir de una entidad de tipo Sucursal entity nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000105, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toEntity de la Clase Sucursal. No es Posible mapear Sucursal entity a partir de una entidad de Sucural domain nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000100, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toDomain de la Clase TipoImagen. No es Posible mapear TipoImagen dominio a partir de una entidad de tipo TipoImagen entity nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000101, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toEntity de la Clase TipoImagen. No es Posible mapear TipoImagen entity a partir de una entidad de TipoImagen  domain nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000102, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toDomain de la Clase TipoPago. No es Posible mapear TipoPago dominio a partir de una entidad de tipo TipoPago entity nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000103, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toEntity de la Clase TipoPago. No es Posible mapear TipoPago entity a partir de una entidad de TipoPago  domain nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000116, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toDomain de la Clase TipoProducto. No es Posible mapear TipoProducto dominio a partir de una entidad de tipo TipoProducto entity nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000117, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toEntity de la Clase TipoProducto. No es Posible mapear TipoProducto entity a partir de una entidad de TipoProducto  domain nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000118, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toEntity de la Clase TipoServicio. No es Posible mapear TipoServicio entity a partir de una entidad de TipoServicio  domain nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000106, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toDomain de la Clase TipoServicio. No es Posible mapear TipoServicio dominio a partir de una entidad de tipo TipoServicio entity nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000107, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toDomain de la Clase CorreoElectronicoCompletaClientes. No es Posible mapear CorreoElectronicoCompletaClientes dominio a partir de una entidad de tipo CorreoElectronicoCompletaClientes entity nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000108, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toEntity de la Clase CorreoElectronicoCompletaClientes. No es Posible mapear CorreoElectronicoCompletaClientes entity a partir de una entidad de CorreoElectronicoCompletaClientes  domain nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000109, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toDomain de la Clase InformacionBasicaServicio. No es Posible mapear InformacionBasicaServicio dominio a partir de una entidad de tipo InformacionBasicaServicio entity nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000110, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,"se ha presentado un problema en el metodo toEntity de la Clase InformacionBasicaServicio. No es Posible mapear InformacionBasicaServicio entity a partir de una entidad de InformacionBasicaServicio domain nula"));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000111, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,""));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000112, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,""));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000113, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,""));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000114, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,""));
		agregarMensaje(Mensaje.crear(CodigoMensaje.M0000115, TipoMensaje.TECNICO, CategoriaMensaje.ERROR,""));
