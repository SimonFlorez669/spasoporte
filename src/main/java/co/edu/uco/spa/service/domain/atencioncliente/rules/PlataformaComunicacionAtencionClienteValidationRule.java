package co.edu.uco.spa.service.domain.atencioncliente.rules;
...
public class PlataformaComunicacionAtencionClienteValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new PlataformaComunicacionAtencionClienteValidationRule();
	private PlataformaComunicacionAtencionClienteValidationRule() {
		super();
	}
	...
	public static void ejecutarValidacion(AtencionClienteDomain data) {
