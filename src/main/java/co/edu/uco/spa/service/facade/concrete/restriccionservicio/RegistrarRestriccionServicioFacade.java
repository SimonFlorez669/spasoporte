package co.edu.uco.spa.service.facade.concrete.restriccionservicio;
...
public class RegistrarRestriccionServicioFacade implements Facade<RestriccionServicioDomain>{

	@Override
	public void execute(RestriccionServicioDomain dto) {
