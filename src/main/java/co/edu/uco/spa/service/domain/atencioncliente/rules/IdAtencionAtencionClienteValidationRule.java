...
public class IdAtencionAtencionClienteValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new IdAtencionAtencionClienteValidationRule();
	private IdAtencionAtencionClienteValidationRule() {
		super();
	}
