...
public class VisionAcercaNosotrosValidationRule  implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new VisionAcercaNosotrosValidationRule();
	
	
	
	private VisionAcercaNosotrosValidationRule() {
		super();
	}
