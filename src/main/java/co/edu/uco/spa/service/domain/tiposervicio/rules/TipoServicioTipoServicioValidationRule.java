...
public class TipoServicioTipoServicioValidationRule implements ValidationRule<String> {
	private static final ValidationRule<String> instancia = new TipoServicioTipoServicioValidationRule();
	private TipoServicioTipoServicioValidationRule() {
		super();
	}
