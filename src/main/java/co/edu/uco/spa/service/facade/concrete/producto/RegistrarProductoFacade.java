package co.edu.uco.spa.service.facade.concrete.producto;
...
public class RegistrarProductoFacade implements Facade<ProductoDomain> {

	@Override
	public void execute(ProductoDomain dto) {
