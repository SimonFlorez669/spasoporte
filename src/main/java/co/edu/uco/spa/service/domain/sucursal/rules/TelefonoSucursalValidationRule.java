...
public class TelefonoSucursalValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new TelefonoSucursalValidationRule();
	private TelefonoSucursalValidationRule() {
		super();
	}
