...
public class UbicacionAcercaNosotrosValidationRule implements ValidationRule<String> {

	
	private static final ValidationRule<String> instancia = new UbicacionAcercaNosotrosValidationRule();
	
	
	
	
	private UbicacionAcercaNosotrosValidationRule() {
		super();
	}
