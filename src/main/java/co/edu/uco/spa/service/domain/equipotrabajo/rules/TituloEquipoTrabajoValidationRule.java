...
public class TituloEquipoTrabajoValidationRule  implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new TituloEquipoTrabajoValidationRule();
	private TituloEquipoTrabajoValidationRule() {
		super();
	}
