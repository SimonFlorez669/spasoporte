package co.edu.uco.spa.service.domain.support.identificacioncompletaclientes.rules;
...
public class NumeroIdentificacionValidationRule implements ValidationRule<String>{
	
	

	private static final ValidationRule<String> instancia = new NumeroIdentificacionValidationRule();
	private NumeroIdentificacionValidationRule() {
		super();
	}
