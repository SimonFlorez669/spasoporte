...
public class RegistrarBancoImagenesValidator implements Validator<BancoImagenesDomain>{
	
	

	private static final Validator<BancoImagenesDomain> instancia = new RegistrarBancoImagenesValidator();
