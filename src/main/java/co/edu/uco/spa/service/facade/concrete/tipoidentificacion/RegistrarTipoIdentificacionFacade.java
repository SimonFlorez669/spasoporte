package co.edu.uco.spa.service.facade.concrete.tipoidentificacion;
...
public final class RegistrarTipoIdentificacionFacade implements Facade <TipoIdentificacionDomain>{
	
	

	@Override
	public void execute(TipoIdentificacionDomain dto) {
