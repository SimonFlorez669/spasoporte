...
public class IdConsentimientoValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new IdConsentimientoValidationRule();
	private IdConsentimientoValidationRule() {
		super();
	}
