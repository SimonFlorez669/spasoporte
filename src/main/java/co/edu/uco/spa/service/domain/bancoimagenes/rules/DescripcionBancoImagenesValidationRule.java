package co.edu.uco.spa.service.domain.bancoimagenes.rules;
...
public class DescripcionBancoImagenesValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new DescripcionBancoImagenesValidationRule();
	private DescripcionBancoImagenesValidationRule() {
		super();
	}
	...
	public static void ejecutarValidacion(BancoImagenesDomain data) {
		// TODO Auto-generated method stub
		
	}

	public static void ejecutarValidacion(OfertaDomain data) {
		// TODO Auto-generated method stub
