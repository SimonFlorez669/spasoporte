...
public class IdTipoImagenValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new IdTipoImagenValidationRule();
	private IdTipoImagenValidationRule() {
		super();
	}
