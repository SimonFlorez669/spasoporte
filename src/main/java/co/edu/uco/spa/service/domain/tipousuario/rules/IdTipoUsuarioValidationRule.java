...
public class IdTipoUsuarioValidationRule implements ValidationRule<String>{

	
	private static final ValidationRule<String> instancia = new IdTipoUsuarioValidationRule();
	private IdTipoUsuarioValidationRule() {
		super();
	}
