...
public class MontoPagoValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new MontoPagoValidationRule();
	private MontoPagoValidationRule() {
		super();
	}
