...
public class DiasDeAtencionAtencionClienteValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new DiasDeAtencionAtencionClienteValidationRule();
	
	
	private DiasDeAtencionAtencionClienteValidationRule() {
		super();
	}
