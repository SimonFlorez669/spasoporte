...
public class DireccionDireccionValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new DireccionDireccionValidationRule();
	private DireccionDireccionValidationRule() {
		super();
	}
