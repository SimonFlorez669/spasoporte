...
public class FotoEquipoTrabajoValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new FotoEquipoTrabajoValidationRule();
	private FotoEquipoTrabajoValidationRule() {
		super();
	}
