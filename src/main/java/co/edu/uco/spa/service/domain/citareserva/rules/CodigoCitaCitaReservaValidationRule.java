package co.edu.uco.spa.service.domain.citareserva.rules;
...
public class CodigoCitaCitaReservaValidationRule implements ValidationRule<String>{
	private static final ValidationRule<String> instancia = new CodigoCitaCitaReservaValidationRule();
	private CodigoCitaCitaReservaValidationRule() {
		super();
	}
	...
	public static void ejecutarValidacion(CitaReservaDomain data) {
