...
public class IdNotificacionValidationRule  implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new IdNotificacionValidationRule();
	private IdNotificacionValidationRule() {
		super();
	}
