package co.edu.uco.spa.service.domain.support.tiempooferta.rules;
...
public class HastaValidationRule implements ValidationRule<String>{
	private static final ValidationRule<String> instancia = new HastaValidationRule();
	private HastaValidationRule() {
		super();
	}
