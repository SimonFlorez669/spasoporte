package co.edu.uco.spa.service.facade.concrete.inventario;
...
public class RegistrarInventarioFacade   implements Facade<InventarioDomain> {

	@Override
	public void execute(InventarioDomain dto) {
