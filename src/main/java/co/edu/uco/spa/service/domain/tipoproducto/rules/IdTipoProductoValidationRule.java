...
public class IdTipoProductoValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new IdTipoProductoValidationRule();
	private IdTipoProductoValidationRule() {
		super();
	}
