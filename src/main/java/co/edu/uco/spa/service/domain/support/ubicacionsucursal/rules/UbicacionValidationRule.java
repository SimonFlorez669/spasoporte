...
public class UbicacionValidationRule  implements ValidationRule<String>{
	
	
	
	private static final ValidationRule<String> instancia = new UbicacionValidationRule();
	private UbicacionValidationRule() {
		super();
	}
