...
public class FechaNacimientoValidationRule implements ValidationRule<String>{
	private static final ValidationRule<String> instancia = new FechaNacimientoValidationRule();
