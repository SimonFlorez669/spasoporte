...
public class RegistrarDireccionValidation  implements Validator<DireccionDomain>{
	

	private static final Validator<DireccionDomain> instancia = new RegistrarDireccionValidation();
