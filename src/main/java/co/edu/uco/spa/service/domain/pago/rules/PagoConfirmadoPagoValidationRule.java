package co.edu.uco.spa.service.domain.pago.rules;
...
public class PagoConfirmadoPagoValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new PagoConfirmadoPagoValidationRule();
	private PagoConfirmadoPagoValidationRule() {
		super();
	}
