package co.edu.uco.spa.service.domain.tipoimagen.rules;
...
public class TipoImagenTipoImagenValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new TipoImagenTipoImagenValidationRule();
	private TipoImagenTipoImagenValidationRule() {
		super();
	}
