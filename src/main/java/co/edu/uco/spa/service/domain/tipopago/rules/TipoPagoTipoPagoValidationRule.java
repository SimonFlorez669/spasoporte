package co.edu.uco.spa.service.domain.tipopago.rules;
...
public class TipoPagoTipoPagoValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new TipoPagoTipoPagoValidationRule();
	private TipoPagoTipoPagoValidationRule() {
		super();
	}
