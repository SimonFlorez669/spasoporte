...
public class RegistrarSursalValidation implements Validator<SucursalDomain>{
	
private static final Validator<SucursalDomain> instancia = new RegistrarSursalValidation();
