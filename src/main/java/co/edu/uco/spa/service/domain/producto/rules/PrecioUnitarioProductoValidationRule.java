...
public class PrecioUnitarioProductoValidationRule  implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new PrecioUnitarioProductoValidationRule();
	private PrecioUnitarioProductoValidationRule() {
		super();
	}
