package co.edu.uco.spa.service.domain.restriccionservicio.rules;
...
public class RestriccionServicioRestriccionServicioValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new RestriccionServicioRestriccionServicioValidationRule();
	private RestriccionServicioRestriccionServicioValidationRule() {
		super();
	}
	...
	public static void ejecutarValidacion(RestriccionServicioDomain data) {
		// TODO Auto-generated method stub
		
	}

	public static void ejecutarValidacion(ServicioDomain data) {
		// TODO Auto-generated method stub
