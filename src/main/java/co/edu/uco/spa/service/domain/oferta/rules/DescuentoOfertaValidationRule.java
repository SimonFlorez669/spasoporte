...
public class DescuentoOfertaValidationRule implements ValidationRule<String>{
	private static final ValidationRule<String> instancia = new DescuentoOfertaValidationRule();
	private DescuentoOfertaValidationRule() {
		super();
	}
