...
public class RegistrarServicioValidation  implements Validator<ServicioDomain>{
	
	
private static final Validator<ServicioDomain> instancia = new RegistrarServicioValidation();
