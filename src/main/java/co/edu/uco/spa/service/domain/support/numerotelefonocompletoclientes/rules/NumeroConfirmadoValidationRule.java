package co.edu.uco.spa.service.domain.support.numerotelefonocompletoclientes.rules;
...
public class NumeroConfirmadoValidationRule implements ValidationRule<String> {
	private static final ValidationRule<String> instancia = new NumeroConfirmadoValidationRule();
	private NumeroConfirmadoValidationRule() {
		super();
	}
