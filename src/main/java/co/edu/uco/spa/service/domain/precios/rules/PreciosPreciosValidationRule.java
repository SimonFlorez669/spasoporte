package co.edu.uco.spa.service.domain.precios.rules;
...
public class PreciosPreciosValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new PreciosPreciosValidationRule();
	private PreciosPreciosValidationRule() {
		super();
	}
	...
	public static void ejecutarValidacion(PreciosDomain data) {
