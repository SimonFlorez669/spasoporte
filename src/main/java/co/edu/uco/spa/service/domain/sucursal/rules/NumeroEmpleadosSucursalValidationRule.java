...
public class NumeroEmpleadosSucursalValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new NumeroEmpleadosSucursalValidationRule();
	private NumeroEmpleadosSucursalValidationRule() {
		super();
	}
