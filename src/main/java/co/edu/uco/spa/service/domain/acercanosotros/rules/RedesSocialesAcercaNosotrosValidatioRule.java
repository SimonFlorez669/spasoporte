...
public class RedesSocialesAcercaNosotrosValidatioRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new RedesSocialesAcercaNosotrosValidatioRule();
	
	
	
	private RedesSocialesAcercaNosotrosValidatioRule() {
		super();
	}
