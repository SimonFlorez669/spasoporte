package co.edu.uco.spa.service.domain.calificacion.rules;
...
public class IdCalificacionValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new IdCalificacionValidationRule();
	private IdCalificacionValidationRule() {
		super();
	}
	...
	public static void ejecutarValidacion(CalificacionDomain data) {
