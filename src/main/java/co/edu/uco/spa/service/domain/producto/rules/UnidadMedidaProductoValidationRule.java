...
public class UnidadMedidaProductoValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new UnidadMedidaProductoValidationRule();
	private UnidadMedidaProductoValidationRule() {
		super();
	}
