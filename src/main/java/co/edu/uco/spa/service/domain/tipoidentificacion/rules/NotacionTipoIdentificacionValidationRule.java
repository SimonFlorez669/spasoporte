...
public class NotacionTipoIdentificacionValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new NotacionTipoIdentificacionValidationRule();
	private NotacionTipoIdentificacionValidationRule() {
		super();
	}
