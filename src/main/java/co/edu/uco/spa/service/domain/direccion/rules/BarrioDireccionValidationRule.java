package co.edu.uco.spa.service.domain.direccion.rules;
...
public class BarrioDireccionValidationRule  implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new BarrioDireccionValidationRule();
	private BarrioDireccionValidationRule() {
		super();
	}
	...
	public static void ejecutarValidacion(DireccionDomain data) {
