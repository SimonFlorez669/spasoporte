package co.edu.uco.spa.service.facade.concrete.direccion;
...
public class RegistrarDireccionFacade implements Facade<DireccionDomain>{

	@Override
	public void execute(DireccionDomain dto) {
