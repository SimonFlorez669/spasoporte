...
public class DepartamentoValidationRule  implements ValidationRule<String>{
	
	
	private static final ValidationRule<String> instancia = new DepartamentoValidationRule();
	private DepartamentoValidationRule() {
		super();
	}
