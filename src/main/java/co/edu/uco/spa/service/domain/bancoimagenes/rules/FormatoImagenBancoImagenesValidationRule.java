...
public class FormatoImagenBancoImagenesValidationRule implements ValidationRule<String>{
	private static final ValidationRule<String> instancia = new FormatoImagenBancoImagenesValidationRule();
	private FormatoImagenBancoImagenesValidationRule() {
		super();
	}
