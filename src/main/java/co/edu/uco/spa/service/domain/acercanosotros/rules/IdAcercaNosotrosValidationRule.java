...
public class IdAcercaNosotrosValidationRule  implements ValidationRule<String>{



	private static final ValidationRule<String> instancia = new IdAcercaNosotrosValidationRule();
	
	
	

	private IdAcercaNosotrosValidationRule() {
		super();
	}
