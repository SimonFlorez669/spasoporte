package co.edu.uco.spa.service.domain.support.informacionbasicaservicio.rules;
...
public class DescripcionServicioValidationRule implements ValidationRule<String>{
	
	
	private static final ValidationRule<String> instancia = new DescripcionServicioValidationRule();
	private DescripcionServicioValidationRule() {
		super();
	}
