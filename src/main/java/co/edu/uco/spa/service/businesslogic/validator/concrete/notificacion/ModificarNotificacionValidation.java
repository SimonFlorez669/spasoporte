...
public class ModificarNotificacionValidation implements Validator<NotificacionDomain>{
	
	
	
private static final Validator<NotificacionDomain> instancia = new ModificarNotificacionValidation();
