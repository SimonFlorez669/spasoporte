package co.edu.uco.spa.service.domain.consentimiento.rules;
...
public class IdConsentimientoConsentimientoValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new IdConsentimientoConsentimientoValidationRule();
	private IdConsentimientoConsentimientoValidationRule() {
		super();
	}
	...
	public static void ejecutarValidacion(ConsentimientoDomain data) {
