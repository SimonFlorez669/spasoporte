...
public class IdOfertaValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new IdOfertaValidationRule();
	private IdOfertaValidationRule() {
		super();
	}
