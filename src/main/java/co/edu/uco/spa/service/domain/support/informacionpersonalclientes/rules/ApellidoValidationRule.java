...
public class ApellidoValidationRule implements ValidationRule<String>{
	private static final ValidationRule<String> instancia = new ApellidoValidationRule();
	private ApellidoValidationRule() {
		super();
	}
