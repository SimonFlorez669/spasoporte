...
public class IdSucursalValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new IdSucursalValidationRule();
	private IdSucursalValidationRule() {
		super();
	}
