...
public class NumeroTelefonoValidationRule implements ValidationRule<String>{
	
	private static final ValidationRule<String> instancia = new NumeroTelefonoValidationRule();
	private NumeroTelefonoValidationRule() {
		super();
	}
