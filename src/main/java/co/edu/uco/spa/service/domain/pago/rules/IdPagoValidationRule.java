...
public class IdPagoValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new IdPagoValidationRule();
	private IdPagoValidationRule() {
		super();
	}
