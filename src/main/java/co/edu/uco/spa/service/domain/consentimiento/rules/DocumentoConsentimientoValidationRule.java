...
public class DocumentoConsentimientoValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new DocumentoConsentimientoValidationRule();
	private DocumentoConsentimientoValidationRule () {
		super();
	}
