...
public class IdDirecionValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new IdDirecionValidationRule();
	private IdDirecionValidationRule() {
		super();
	}
