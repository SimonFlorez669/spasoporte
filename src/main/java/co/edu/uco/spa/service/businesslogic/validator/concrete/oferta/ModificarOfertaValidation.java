...
public class ModificarOfertaValidation implements Validator<OfertaDomain>{
	
	
	
private static final Validator<OfertaDomain> instancia = new ModificarOfertaValidation();
