...
public class ModificarInventarioValidation implements Validator<InventarioDomain> {
	
	
	private static final Validator<InventarioDomain> instancia = new ModificarInventarioValidation();
