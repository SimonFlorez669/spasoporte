package co.edu.uco.spa.service.domain.oferta.rules;
...
public class DescripcionOfertaValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new DescripcionOfertaValidationRule();
	private DescripcionOfertaValidationRule() {
		super();
	}
