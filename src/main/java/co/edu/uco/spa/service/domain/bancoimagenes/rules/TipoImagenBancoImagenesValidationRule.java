...
public class TipoImagenBancoImagenesValidationRule implements ValidationRule<String> {

	
	private static final ValidationRule<String> instancia = new TipoImagenBancoImagenesValidationRule();
	private TipoImagenBancoImagenesValidationRule() {
		super();
	}
