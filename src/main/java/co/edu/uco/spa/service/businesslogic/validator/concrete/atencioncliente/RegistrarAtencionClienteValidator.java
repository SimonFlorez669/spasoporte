...
public class RegistrarAtencionClienteValidator implements Validator<AtencionClienteDomain>{
	
	
	private static final Validator<AtencionClienteDomain> instancia = new RegistrarAtencionClienteValidator();
