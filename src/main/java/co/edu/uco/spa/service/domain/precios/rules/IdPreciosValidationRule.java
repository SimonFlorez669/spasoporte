...
public class IdPreciosValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new IdPreciosValidationRule();
	private IdPreciosValidationRule() {
		super();
	}
