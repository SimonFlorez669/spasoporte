...
public class IdTipoPagoValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new IdTipoPagoValidationRule();
	private IdTipoPagoValidationRule() {
		super();
	}
