...
public class DuracionValidationRule implements ValidationRule<String> {
	
	
	private static final ValidationRule<String> instancia = new DuracionValidationRule();
	private DuracionValidationRule() {
		super();
	}
