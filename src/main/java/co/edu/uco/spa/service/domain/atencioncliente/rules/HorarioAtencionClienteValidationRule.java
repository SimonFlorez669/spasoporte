...
public class HorarioAtencionClienteValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new HorarioAtencionClienteValidationRule();
	private HorarioAtencionClienteValidationRule() {
		super();
	}
