package co.edu.uco.spa.service.domain.producto.rules;
...
public class CantidadExistenteProductoValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new CantidadExistenteProductoValidationRule();
	private CantidadExistenteProductoValidationRule() {
		super();
	}
	...
	public static void ejecutarValidacion(ProductoDomain data) {
		// TODO Auto-generated method stub
