...
public class IdRestriccionServicioValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new IdRestriccionServicioValidationRule();
	private IdRestriccionServicioValidationRule() {
		super();
	}
