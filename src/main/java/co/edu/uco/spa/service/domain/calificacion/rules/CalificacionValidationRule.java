...
public class CalificacionValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new CalificacionValidationRule();
	private CalificacionValidationRule() {
		super();
	}
