...
public class CargoEquipoTrabajoValidationRule  implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new CargoEquipoTrabajoValidationRule();
	private CargoEquipoTrabajoValidationRule() {
		super();
	}
