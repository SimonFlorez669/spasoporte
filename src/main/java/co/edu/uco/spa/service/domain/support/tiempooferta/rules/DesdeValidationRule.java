...
public class DesdeValidationRule implements ValidationRule<String>{
	private static final ValidationRule<String> instancia = new DesdeValidationRule();
	private DesdeValidationRule() {
		super();
	}
