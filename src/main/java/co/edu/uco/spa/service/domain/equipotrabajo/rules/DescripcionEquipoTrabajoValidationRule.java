...
public class DescripcionEquipoTrabajoValidationRule implements ValidationRule<String> {

	
	private static final ValidationRule<String> instancia = new DescripcionEquipoTrabajoValidationRule();
	private DescripcionEquipoTrabajoValidationRule() {
		super();
	}
