package co.edu.uco.spa.service.domain.support.correoelectronicocompletoclientesdomain.rules;
...
public class CorreoElectronicoConfirmadoValidationRule  implements ValidationRule<String>{
	
	
	private static final ValidationRule<String> instancia = new CorreoElectronicoConfirmadoValidationRule();
	private CorreoElectronicoConfirmadoValidationRule() {
		super();
	}
