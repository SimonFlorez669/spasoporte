...
public class ModificarProductoValidation implements Validator<ProductoDomain>{

	
	
private static final Validator<ProductoDomain> instancia = new ModificarProductoValidation();
