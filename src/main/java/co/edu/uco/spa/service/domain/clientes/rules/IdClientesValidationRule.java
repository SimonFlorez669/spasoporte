package co.edu.uco.spa.service.domain.clientes.rules;
...
public class IdClientesValidationRule  implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new IdClientesValidationRule();
	private IdClientesValidationRule() {
		super();
	}
