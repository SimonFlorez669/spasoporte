...
public class MisionAcercaNosotrosValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new MisionAcercaNosotrosValidationRule();
	
	
	private MisionAcercaNosotrosValidationRule() {
		super();
	}
