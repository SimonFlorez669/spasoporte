...
public class IdBancoImagenesValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new IdBancoImagenesValidationRule();
	private IdBancoImagenesValidationRule() {
		super();
	}
