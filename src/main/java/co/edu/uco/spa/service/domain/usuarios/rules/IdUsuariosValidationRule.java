package co.edu.uco.spa.service.domain.usuarios.rules;
...
public class IdUsuariosValidationRule implements ValidationRule<String> {
	
	
	
	private static final ValidationRule<String> instancia = new IdUsuariosValidationRule();
	private IdUsuariosValidationRule() {
		super();
	}
