package co.edu.uco.spa.service.domain.inventario.rules;
...
public class IdInventarioValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new IdInventarioValidationRule();
	private IdInventarioValidationRule() {
		super();
	}
