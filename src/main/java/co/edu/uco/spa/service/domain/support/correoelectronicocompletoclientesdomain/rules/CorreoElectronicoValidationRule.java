...
public class CorreoElectronicoValidationRule implements ValidationRule<String>{
	
	private static final ValidationRule<String> instancia = new CorreoElectronicoValidationRule();
