...
public class EstadoPagoValidationRule  implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new EstadoPagoValidationRule();
	private EstadoPagoValidationRule() {
		super();
	}
