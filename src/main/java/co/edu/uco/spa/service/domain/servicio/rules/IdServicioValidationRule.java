package co.edu.uco.spa.service.domain.servicio.rules;
...
public class IdServicioValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new IdServicioValidationRule();
