package co.edu.uco.spa.service.domain.equipotrabajo.rules;
...
public class NombreEmpleadoEquipoTrabajoValidationRule  implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new NombreEmpleadoEquipoTrabajoValidationRule();
	private NombreEmpleadoEquipoTrabajoValidationRule() {
		super();
	}
	...
	public static void ejecutarValidacion(EquipoTrabajoDomain data) {
		// TODO Auto-generated method stub
