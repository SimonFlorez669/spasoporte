package co.edu.uco.spa.service.facade.concrete.bancoimagenes;
...
public class RegistrarBancoImagenesFacade implements Facade<BancoImagenesDomain>{
	
	
	

	@Override
	public void execute(BancoImagenesDomain dto) {
