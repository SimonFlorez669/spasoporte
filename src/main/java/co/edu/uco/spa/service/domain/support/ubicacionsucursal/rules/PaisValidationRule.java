...
public class PaisValidationRule implements ValidationRule<String> {
	private static final ValidationRule<String> instancia = new PaisValidationRule ();
	private PaisValidationRule() {
		super();
	}
