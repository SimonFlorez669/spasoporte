...
public class NombreProductoValidationRule  implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new NombreProductoValidationRule();
	private NombreProductoValidationRule() {
		super();
	}
