package co.edu.uco.spa.service.domain.tipousuario.rules;
...
public class TipoUsuarioTipoUsuarioValidationRule implements ValidationRule<String> {
	
	
	
	
	private static final ValidationRule<String> instancia = new TipoUsuarioTipoUsuarioValidationRule();
	private TipoUsuarioTipoUsuarioValidationRule() {
		super();
	}
