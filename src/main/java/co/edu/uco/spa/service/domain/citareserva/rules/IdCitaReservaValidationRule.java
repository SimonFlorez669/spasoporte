...
public class IdCitaReservaValidationRule implements ValidationRule<String> {
	
	private static final ValidationRule<String> instancia = new IdCitaReservaValidationRule();
	private IdCitaReservaValidationRule() {
		super();
	}
