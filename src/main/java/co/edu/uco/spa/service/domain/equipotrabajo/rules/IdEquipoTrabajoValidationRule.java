...
public class IdEquipoTrabajoValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new IdEquipoTrabajoValidationRule();
	private IdEquipoTrabajoValidationRule() {
		super();
	}
