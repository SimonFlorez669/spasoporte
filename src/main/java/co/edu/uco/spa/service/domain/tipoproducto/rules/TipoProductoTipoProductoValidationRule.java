package co.edu.uco.spa.service.domain.tipoproducto.rules;
...
public class TipoProductoTipoProductoValidationRule implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new TipoProductoTipoProductoValidationRule();
	private TipoProductoTipoProductoValidationRule() {
		super();
	}
