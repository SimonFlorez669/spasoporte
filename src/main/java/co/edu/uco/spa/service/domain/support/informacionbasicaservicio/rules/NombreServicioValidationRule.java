...
public class NombreServicioValidationRule  implements ValidationRule<String>{
	
	private static final ValidationRule<String> instancia = new NombreServicioValidationRule();
	private NombreServicioValidationRule() {
		super();
	}
