...
public class IdTipoProductoProductoValidationRule implements ValidationRule<String> {

	private static final ValidationRule<String> instancia = new IdTipoProductoProductoValidationRule();
	private IdTipoProductoProductoValidationRule() {
		super();
	}
