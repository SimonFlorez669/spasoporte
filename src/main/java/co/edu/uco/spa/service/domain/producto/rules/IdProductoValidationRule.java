...
public class IdProductoValidationRule  implements ValidationRule<String>{

	private static final ValidationRule<String> instancia = new IdProductoValidationRule();
	private IdProductoValidationRule() {
		super();
	}
